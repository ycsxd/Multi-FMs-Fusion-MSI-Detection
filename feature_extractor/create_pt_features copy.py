...
parser.add_argument('--backbone', default='',type=str,choices=['vit_s_imagenet','resnet50_imagenet','musk','plip','conch','uni','ctranspath','gigapath','virchow','virchow_v2','conch_v1_5'], help='backbone model')
