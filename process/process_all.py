...
def process(args,yaml_path,options):
    ...
    elif args.General.MODEL_NAME == 'CLAM_MB_MIL_ENSEMBLE':
        from .CLAM_MB_MIL.process_clam_mb_mil_ensemble import process_CLAM_MB_MIL_ENSEMBLE
        process_CLAM_MB_MIL_ENSEMBLE(args)
    elif args.General.MODEL_NAME == 'CLAM_MB_MIL_FUSION':
        from .CLAM_MB_MIL.process_clam_mb_mil_fusion import process_CLAM_MB_MIL_FUSION
        process_CLAM_MB_MIL_FUSION(args)
